[x1,fs]=audioread('p232_030_W.wav');
[x4,fs]=audioread('p232_054_W.wav');
[x7,fs]=audioread('p232_066_W.wav');
[x10,fs]=audioread('p257_289_W.wav');
[x13,fs]=audioread('p257_369_W.wav');

[x2,fs]=audioread('enhanced_p232_030__mixed_conditioned0_12dB.wav');
[x5,fs]=audioread('enhanced_p232_054__mixed_conditioned0_12dB.wav');
[x8,fs]=audioread('enhanced_p232_066__mixed_conditioned0_12dB.wav');
[x11,fs]=audioread('enhanced_p257_289__mixed_conditioned0_12dB.wav');
[x14,fs]=audioread('enhanced_p257_369__mixed_conditioned0_11dB.wav');
