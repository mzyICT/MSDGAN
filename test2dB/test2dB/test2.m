[x1,fs]=audioread('p232_023_W.wav');
[x4,fs]=audioread('p232_092_W.wav');
[x7,fs]=audioread('p232_104_W.wav');
[x10,fs]=audioread('p257_054_W.wav');
[x13,fs]=audioread('p257_143_W.wav');

[x2,fs]=audioread('enhanced_p232_023__mixed_conditioned0_2dB.wav');
[x5,fs]=audioread('enhanced_p232_092__mixed_conditioned0_2dB.wav');
[x8,fs]=audioread('enhanced_p232_104__mixed_conditioned0_2dB.wav');
[x11,fs]=audioread('enhanced_p257_054__mixed_conditioned0_2dB.wav');
[x14,fs]=audioread('enhanced_p257_143__mixed_conditioned0_2dB.wav');
